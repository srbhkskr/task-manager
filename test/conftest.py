...
ADMIN_DATABASE_URL = os.getenv("ADMIN_DATABASE_URL",
                               "postgresql://postgres:root@127.0.0.1/postgres")
TEST_DATABASE_URL = os.getenv("TEST_DATABASE_URL",
                              "postgresql://postgres:root@127.0.0.1/test_task_manager_db")
...
def create_test_database():
    ...
    with admin_engine.connect() as connection:
        try:
            ...
            raise SystemError(f"Error while checking db {type(e)}") from e
